...
import struct
from data_utils.get_imagenet import get_train_dataloader, get_val_dataloader
...
class DataLoader(object):
	...
	def imagenet(self, dataset="imagenet"):
		...
		# my dataloader 
		test_loader = get_val_dataloader(self.data_path, batchsize=self.batch_size, num_workers=self.n_threads)
		#train_loader = get_train_dataloader(self.data_path, batchsize=self.batch_size, num_workers=self.n_threads)
		train_loader = None
		'''
		# original dataloader
